  ...
  return (
    <div className="h-screen overflow-y-auto snap-y snap-mandatory no-scrollbar select-none">
      <header className="fixed top-0 w-full z-50 flex justify-between items-center px-8 py-5 bg-white/5 backdrop-blur-md border-b border-white/10">
        ...
        <button className="bg-white text-black px-5 py-2 rounded-full font-bold text-sm hover:bg-orange-500 hover:text-white transition-all duration-300">
          이용 문의하기
        </button>
      </header>
      ...
      <div className="fixed bottom-10 right-10 flex flex-col gap-4 z-[100]">
        ...
        <motion.button 
          whileHover={{ scale: 1.1 }}
          whileTap={{ scale: 0.9 }}
          className="bg-white w-16 h-16 rounded-3xl shadow-2xl flex items-center justify-center text-black"
        >
          <PhoneCall size={28} />
        </motion.button>
      </div>
